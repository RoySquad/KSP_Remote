...
public class UltimateJoystickWindow : EditorWindow
{
	...
	class UltimateJoystickInitialLoad
	{
		...
		static void WaitForCompile ()
		{
			...
			//UltimateJoystickWindow ujWindow = ( UltimateJoystickWindow ) GetWindow( typeof( UltimateJoystickWindow ) );
			//ujWindow.maxSize = new Vector2( 500, 500 );
			//ujWindow.minSize = new Vector2( 500, 500 );
			//ujWindow.Show();
